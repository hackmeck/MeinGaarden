 ...
 */
public class HotSpotsListActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setContentView(R.layout.activity_main);       // alt
        setContentView(R.layout.activity_hotspots);     // neu

        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction()
                    //.add(R.id.container, new AttractionListFragment())    // alt
                    .add(R.id.container, new HotSpotsListFragment())         // neu
                    .commit();
        }
    ...
    private void fineLocationPermissionGranted() {
        ...
        UtilityService.addHotSpotGeofences(this);
        UtilityService.requestLocation(this);
    }
