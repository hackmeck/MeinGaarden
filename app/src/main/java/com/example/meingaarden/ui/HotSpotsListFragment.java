...
//import static com.example.secretlaboratory.provider.TouristAttractions.ATTRACTIONS;     // alt
 ...
 */
public class HotSpotsListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        List<HotSpot> hotspots = loadHotspotsFromLocation(mLatestLocation);
        mAdapter = new HotSpotAdapter(getActivity(), hotspots);
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (location != null) {
                ...
                mAdapter.mHotSpotList = loadHotspotsFromLocation(mLatestLocation);
                mAdapter.notifyDataSetChanged();
            }
        }
    };

    private static List<HotSpot> loadHotspotsFromLocation(final LatLng curLatLng) {
    ...
    private class HotSpotAdapter extends RecyclerView.Adapter<ViewHolder>
            implements ItemClickListener {

        public List<HotSpot> mHotSpotList;
        private Context mContext;

        public HotSpotAdapter(Context context, List<HotSpot> hotspots) {
            super();
            mContext = context;
            mHotSpotList = hotspots;
        }
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            HotSpot hotspot = mHotSpotList.get(position);

            holder.mTitleTextView.setText(hotspot.name);
            holder.mDescriptionTextView.setText(hotspot.description);
            Glide.with(mContext)
                    .load(hotspot.imageUrl)
            ...
            String distance =
                    Utils.formatDistanceBetween(mLatestLocation, hotspot.location);
        ...
        public int getItemCount() {
            return mHotSpotList == null ? 0 : mHotSpotList.size();
        }
        ...
        public void onItemClick(View view, int position) {
            if (!mItemClicked) {
                ...
                DetailHotSpotActivity.launch(
                        getActivity(), mAdapter.mHotSpotList.get(position).name, heroView);
            }
        }
    }
