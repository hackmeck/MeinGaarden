 ...
 * {@link com.example.meingaarden.ui.DetailActivity}).
 */
        ...
        mapFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse(Constants.MAPS_INTENT_URI +
                        ...
                        mAttraction.location.latitude+ ", " +mAttraction.location.longitude)); // neue Methode, fragt nach Lat+Lng, zeigt immer einen Standort an
